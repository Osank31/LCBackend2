  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center bg-darkBg p-6">
      <div className="w-full max-w-md bg-darkPanel border border-darkBorder p-8">
        ...
        {/* Title Header */}
        <div className="mb-8">
          <h2 className="text-2xl font-mono font-bold tracking-tight text-white uppercase">SIGN_IN</h2>
          <p className="text-xs text-text-secondary mt-1 font-mono">ENTER YOUR CREDENTIALS TO ENTER THE ARENA</p>
        </div>
        ...
        {error && (
          <div className="mb-6 flex items-start gap-2 bg-brandRed/10 border border-brandRed text-brandRed p-3.5 text-xs font-mono">
            ...
            <div>
              <span className="font-bold">AUTHENTICATION_ERROR:</span> {error.toUpperCase()}
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-mono font-bold text-text-secondary uppercase">EMAIL_ADDRESS</label>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <label className="block text-xs font-mono font-bold text-text-secondary uppercase">SECRET_KEY</label>
              <Link 
                to="/forgot-password" 
        ...
        <div className="mt-8 pt-6 border-t border-darkBorder text-center">
          <p className="text-xs text-text-secondary font-mono">
            NEW_RECRUIT?{' '}
            <Link to="/register" className="text-brandBlue hover:underline font-bold uppercase">
              Register Here
            </Link>
          </p>
        </div>
